                ...
                <div>
                    <div class="py-12 sm:py-5">
                        <div class="w-full pb-2 flex items-center gap-7 border-b-2 sm:gap-3">
                            ...
                            <input v-model="query" @input="search" class="w-full border-none outline-none font-onest-medium text-xl sm:text-base bg-transparent" placeholder="Mualliflar bo'yicha qidiruv" type="text">
                        </div>
                    </div>
                </div>
