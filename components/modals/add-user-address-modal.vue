            ...
            <div class="p-8 outline-none overscroll-none sm:p-5">
                <div class="flex flex-col gap-12 justify-start w-[520px] sm:w-full sm:gap-3 sm:h-[430px]">
                    ...
                    <div class="flex flex-col gap-7 sm:gap-5">
                        ...
                        <div class="font-onest-medium text-base text-center sm:text-sm">
                            {{ locale === 'ru' ? 'Добавить адрес' : 'Manzil qo\'shish' }}
                        </div>

                        <div class="flex flex-col gap-5 sm:gap-3">
                            <div class="flex justify-between items-center w-full">
                                <div class="w-1/3 font-onest-medium text-base sm:text-sm">
                                ...
                                <div class="w-2/3">
                                    <input
                                        ...
                                        type="text"
                                        class="bg-transparent w-full outline-none border-x-0 text-base sm:text-sm font-onest-regular border-opacity-20 border-b border-black"
